...
class LimbRiggerWidget(QWidget):
    ...
    def BuildRig(self):
        ...
        mc.expression(s=f"{poleVectorCtrlGrpName}.ikBlend={ikfkBlendCtrlName}.{ikfkBlendAttr}")
    ...
    def BuildIkControls(self, rootJnt, midJnt, endJnt):
        ...
        # get(q=True) the world space(ws=True) translation (t=True) of the root joint
        ...
        poleVectorGrpName = poleVectorCtrlName + "_grp"
        mc.spaceLocator(n=poleVectorCtrlName)
        mc.group(poleVectorCtrlName, n = poleVectorGrpName)
        mc.move(poleVectorCtrlPos[0], poleVectorCtrlPos[1], poleVectorCtrlPos[2], poleVectorGrpName)
        
        mc.poleVectorConstraint(endCtrlName, ikHandleName)
        mc.parent(ikHandleName, endCtrlGrpName)

        return endCtrlName, endCtrlGrpName, poleVectorCtrlName, poleVectorCtrlName, ikHandleName
    ...
    def CreateFKCtrlForJnt(self, jnt):
        ...
        mc.orientConstraint(ctrlGrpName, jnt)
    ...
    def GetWindowUniqueId():
        return "cc1426b6362a7daf73338e2742531a1a"
