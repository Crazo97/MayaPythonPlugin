...
class TrimSheetUVBuilderWidget(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Trimsheet UV builder") #The name of the Window
    ...
    def CreateManipulationSection(self):
        ...
        moveToOriginBtn = QPushButton("Back to Origin")
        ...
        doVbleVBtn = QPushButton("Double V")
        doVbleVBtn.clicked.connect(lambda : self.ScaleShell(1, 2))
        sectionLayout.addWidget(doVbleVBtn)
    ...
    def CreateInitializationSection(self):
        ...
        unfoldBtn = QPushButton("Unfold") #Creating a button for Unfold
    ...
    def GetWindowUniqueId():
        return "cc1426b614322a7daf734328e2242531a1a"
